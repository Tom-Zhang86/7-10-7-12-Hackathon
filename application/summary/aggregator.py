...
class DailyDataAggregator:
    ...
    def _attention_windows(
        ...
        allowed = (
            ...
            "mouse_average_idle_gap_seconds",
            "mouse_longest_idle_gap_seconds",
            ...
            "keyboard_detail_available",
            "keystrokes_per_minute",
            "average_typing_burst_length",
            "longest_typing_burst_length",
            "average_inter_key_interval_seconds",
            "median_inter_key_interval_seconds",
            "typing_pause_distribution",
            "correction_count",
            "correction_rate",
            "shortcut_count",
            "shortcut_rate",
            ...
            "interface_dwell_time_cv",
            "interface_dwell_stability",
            "interface_short_dwell_ratio",
            "interface_return_count",
            "interface_return_rate",
            "interface_return_patterns",
            "interface_change_origin_counts",
            "presence_sensor",
            "mouse_state",
            "keyboard_state",
            "content_state",
